...
import personal.projects.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "KwizApp.db";
    private static final int DATABASE_VERSION = 1;

    private SQLiteDatabase db; // Reference to the actual database
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(SQL_CREATE_QUESTIONS_TABLE); // Execute the SQL statement
        fillQuestionsTable();
    }
    ...
    public ArrayList<Question> getAllQuestions() {
        ...
        if (c.moveToFirst()) { // Returns false if there is no entry
            do {
